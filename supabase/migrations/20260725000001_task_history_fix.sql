-- Tabela crm_task_history nie istniała w bazie produkcyjnej (część migracji
-- 20260610000001_tasks_extra.sql nie została zaaplikowana). Odtwarzamy ją tutaj
-- idempotentnie — rejestr zmian statusów zadań oraz zapisy z toggleStatus.
...
drop policy if exists "tenant_isolation_task_history" on crm_task_history;
